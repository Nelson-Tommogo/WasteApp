...
class CreateIssues extends StatefulWidget {
  const CreateIssues({Key? key}) : super(key: key);
...
class _CreateIssuesState extends State<CreateIssues> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Headers(title: "Report Event",getBack: true,),
  ...
  Widget buttonNext() {
    return InkWell(
      onTap: () {
        ...
        if (location.isNotEmpty  && bio.isNotEmpty && _image != null) {
          createEvent();
        } else {
  ...
  Future<void> createEvent() async {
    ...
    final message =   await AuthService().createIssue(
      bio: getBio.text,
