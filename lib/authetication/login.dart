...
import 'package:chemba/authetication/register.dart';
import 'package:chemba/authetication/reset.dart';
        ...
        children: [
          ...
          InkWell(
            ...
            child: Text(
              ...
              style: const TextStyle(
                  fontWeight: FontWeight.w400, color: ColorList.black, fontSize: 13),
            ),
          ),
        ],
      ),
